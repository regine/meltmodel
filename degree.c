...
#include "function.h"    /* all function heads, first line */
...
/*------- FOR EACH GRID POINT - only for drainage basin grids (defining the area to be computed)--*/
 ...
 /*==================================================================*/
   ...
   switch(ddmethod)
    ...
    {  case 1:  degreedaymelt();    /*CALCULATING MELT WITH DEGREE DAY*/
		  break;
       case 2:  dd_directmelt();    /*INCLUDING DIRECT RADIATION (J.Glac. 1999)*/
		  break;
       case 3:  dd_directglobal();  /*AS BUT INCLUDING GLOBAL RAD (J.GLAC 1999)*/
		 break;
