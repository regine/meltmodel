...
int main(int argc,char *paramstring[])
{
  ...
  if (argc<3)
  {
    ...
    printf("\nEingabedatei : ");dateinameein=gets(dateinameein);
    printf("\nAusgabedatei : ");dateinameaus=gets(dateinameaus);
    printf("\n");
  }
  else
  {
  ...
  s = 6;
  switch (digits) {
  case '0':   sprintf(frmt,"%%6.0f ");  break;
  case '1':   sprintf(frmt,"%%6.1f ");  break;
  case '2':   sprintf(frmt,"%%6.2f ");  break;
  case '3':   sprintf(frmt,"%%6.3f ");  break;
  case '4':   sprintf(frmt,"%%6.4f ");  break;
  case '5':   sprintf(frmt,"%%7.5f ");  break;
  case '6':   sprintf(frmt,"%%8.6f ");  break;
  case '7':   sprintf(frmt,"%%9.7f ");  break;
  case '8':   sprintf(frmt,"%%10.8f "); break;
  case '9':   sprintf(frmt,"%%10.8g "); break;
  default :   sprintf(frmt,"%%6.2f ");
  }
