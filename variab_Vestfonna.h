...
/*  variab.h                                                 */
/*    update 3 Jan 2011 */
/*  FOR VESTFONNA APPLICATION, ONLY ONE GRID CELL COMPUTED*/
/*  NEEDS ADJUSTMENT FOR OTHER APPLICATIONS*/
/*************************************************************/
...
/*HIDDEN OPTIONS TO ADJUST ========*/
 ...
 int    calcgridyes = 1;   /*compute whole grid (=1) or only climate station cell (=2)*/
...
/********** TIME SERIES OUTPUT **************************/
 ...
 float  tempgrad,precgrad,precgradhigh,snowmultiplier;    /*for temp,precip interpolation*/
...
/*==== ADD ndl, ndh for snow model, 2/2005*/
 ...
 int    nglac;                  /*number of glacier grids*/
...
/***** for DISCHARGE calculation **************/
 ...
 double  **qfirnopt,**qsnowopt,**qiceopt;  /*for optimization*/
 ...
 float  sumk1=0,sumk2=0,sumk3=0;     /*water volumes of reservoirs (firn,snow,ice)*/
 int    onlyglacieryes;    /* =1 if melt is not calculated for whole basin*/
 float  glacierpart;         /*glacierized percentage*/
 float  firnkons,snowkons,icekons;   /*storage constants k*/
 float  qground;
 float  qfirnstart,qsnowstart,qicestart;  /*starting values*/
 float  qfirnsim,qsnowsim,qicesim;        /*for simulation*/
